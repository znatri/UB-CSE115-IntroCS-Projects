...
// Part D (6 points) - JavaScript comparator & custom sorting functions

function rossTrophy(obj1, obj2) {
  // Assign "points", "goals", and "games"

  if (obj1.points != obj1.points) 
  {
    if (obj1.points < obj1.points) 
    {
      return -1;
    } else if (obj1.points > obj1.points) 
    {
      return 1;
    }
  } 
  else if (obj1.goals != obj2.goals) 
  {
    if (obj1.goals < obj1.goals) 
    {
      return -1;
    } else if (obj1.goals > obj1.goals) 
    {
      return 1;
    }
  } 
